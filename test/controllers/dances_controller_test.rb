...
class DancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dance" do
    assert_difference('Dance.count') do
      post dances_url, params: { dance: { category_id: @dance.category_id, description: @dance.description, title: @dance.title } }
    end
  ...
  test "should update dance" do
    patch dance_url(@dance), params: { dance: { category_id: @dance.category_id, description: @dance.description, title: @dance.title } }
