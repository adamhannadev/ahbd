...
class RoutinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create routine" do
    assert_difference('Routine.count') do
      post routines_url, params: { routine: { category: @routine.category, dance: @routine.dance, description: @routine.description, level: @routine.level, song: @routine.song, student_id: @routine.student_id } }
    end
  ...
  test "should update routine" do
    patch routine_url(@routine), params: { routine: { category: @routine.category, dance: @routine.dance, description: @routine.description, level: @routine.level, song: @routine.song, student_id: @routine.student_id } }
