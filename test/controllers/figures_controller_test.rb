...
class FiguresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create figure" do
    assert_difference('Figure.count') do
      post figures_url, params: { figure: { dance_id: @figure.dance_id, description: @figure.description, level_id: @figure.level_id, title: @figure.title } }
    end
  ...
  test "should update figure" do
    patch figure_url(@figure), params: { figure: { dance_id: @figure.dance_id, description: @figure.description, level_id: @figure.level_id, title: @figure.title } }
